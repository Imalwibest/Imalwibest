...
tab:CreateToggle("Farm coin [Patcthed]",false,function(free) 
_G.Coin = free
...
tab:CreateToggle("Farm coin V2",false,function(gyat) 
_G.MyRyluIsgay = gyat
while _G.MyRyluIsgay == true do
local args = {
    [1] = "ReturnBoat"
}

game:GetService("ReplicatedStorage"):WaitForChild("Packages"):WaitForChild("_Index"):WaitForChild("sleitnick_knit@1.7.0"):WaitForChild("knit"):WaitForChild("Services"):WaitForChild("RideService"):WaitForChild("RF"):WaitForChild("RequestRideStart"):InvokeServer(unpack(args))
end
end) 

tab:CreateButton("Auto redeem all code", function()
local codes = {
    "PIFly",
    "PISun2",
    "PIBest2",
