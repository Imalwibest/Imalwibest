...
local imageIDs = { "rbxassetid://9844409209" }
local credits = { "Alwi || Ikura" }
local loadTimeMessage = "Alwi Hub" .. string.format("%.20f", elapsedTime) .. " SECONDS"
